...
class AIAdvisor {
  ...
  _render(){
    ...
    this._content.innerHTML = `
      <div class="ai-chat" id="ai-chat-container" style="min-height:300px;max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:6px;padding-bottom:8px;">
        <!-- Info bandeau -->
