...
const PHASES = [
  {
    id:1, label:'ADAPTATION',        color:'#00ffcc',
    fatMin:0,    fatMax:0.35, weekH:[0, 40],
    desc:'Fatigue limitée. Récupération nocturne efficace. Corps en équilibre.',
    context:'Le système nerveux et hormonal gèrent correctement la charge. La dette de sommeil reste nulle ou très faible.',
  ...
  {
    id:2, label:'FATIGUE CHRONIQUE', color:'#ffb300',
    fatMin:0.35, fatMax:0.60, weekH:[40, 52],
    desc:'Cortisol élevé en continu. Troubles du sommeil. Irritabilité croissante.',
    context:'Axe HPA (hypothalamo-hypophyso-corticosurrénalien) activé en permanence. Cortisol +14% dès la 1ère nuit insuffisante (Thompson 2022). La dette de sommeil s\'accumule sur les semaines.',
  ...
  {
    id:3, label:'SURMENAGE',         color:'#ff6600',
  ...
  {
    id:4, label:'BURN-OUT',          color:'#ff2244',
    fatMin:0.80, fatMax:1.00, weekH:[55, 999],
    desc:'Effondrement physiologique. +35% AVC (OMS 2021). 745 194 décès/an. Arrêt médical probable.',
    context:'L\'OMS/OIT 2021 estime 745 194 décès/an liés aux longues heures. À ≥55h/sem : RR=1.35 AVC, RR=1.17 cardiopathies. Le syndrome d\'épuisement professionnel (HAS 2017) est une réalité médicale. Les modifications cérébrales (OEM 2025) peuvent prendre des mois à se résorber.',
