...
class LeagueSystem {
    constructor() {
        this.leagues = [
            ...
            { id: 2, img: '../images/Argent.PNG', name: 'Argent', icon: '\uD83E\uDD48', minXP: 5000, color: '#C0C0C0' },
            { id: 3, img: '../images/Or.PNG', name: 'Or', icon: '\uD83E\uDD47', minXP: 15000, color: '#FFD700' },
            { id: 4, img: '../images/Platine.PNG', name: 'Platine', icon: '\uD83D\uDC8E', minXP: 30000, color: '#E5E4E2' },
            { id: 5, img: '../images/Diamant.PNG', name: 'Diamant', icon: '\uD83D\uDCA0', minXP: 50000, color: '#B9F2FF' },
            { id: 6, img: '../images/Maitre.PNG', name: 'Maître', icon: '\uD83C\uDF1F', minXP: 70000, color: '#FF6B9D' },
            { id: 7, img: '../images/Grand_Maitre.PNG', name: 'Grand Maître', icon: '\uD83D\uDC51', minXP: 85000, color: '#FFD700' },
            { id: 8, img: '../images/Champion.PNG', name: 'Champion', icon: '\uD83D\uDD25', minXP: 95000, color: '#FF4500' },
            { id: 9, img: '../images/Heros.PNG', name: 'Héros', icon: '\u26A1', minXP: 105000, color: '#00BFFF' },
            { id: 10, img: '../images/Legende.PNG', name: 'Légende', icon: '\uD83C\uDFC6', minXP: 110000, color: '#FF00FF' }
        ];
    }
