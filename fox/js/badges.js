...
class BadgeSystem {
    ...
    initializeBadges() {
        return [
            ...
            { id: 56, img: '../images/Narrateur.PNG',        name: 'Narrateur',         icon: '\uD83D\uDCD6', rarity: 'rare',      description: '10 sc\u00E9narios narr\u00E9s par Kitsune',                      condition: (s) => s.scenariosNarrated >= 10 },
            ...
            { id: 60, img: '../images/Bien_Etre.PNG',        name: 'Bien-\u00CAtre',         icon: '\uD83C\uDF3F', rarity: 'rare',      description: '3 sc\u00E9narios bien-\u00EAtre narr\u00E9s par Kitsune',             condition: (s) => s.scenariosWellbeing >= 3 },
            { id: 61, img: '../images/Grand_Narrateur.PNG',  name: 'Grand Narrateur',   icon: '\uD83D\uDCDA', rarity: 'epic',      description: '30 sc\u00E9narios narr\u00E9s par Kitsune',                      condition: (s) => s.scenariosNarrated >= 30 },
            { id: 62, img: '../images/Contingent_50.PNG',    name: 'Contingent 50%',    icon: '\u23F0', rarity: 'epic',      description: '50% du contingent annuel consomm\u00E9 (110h/220h)',         condition: (s) => s.contingentPercent >= 50 },
            { id: 63, img: '../images/Alerte_Rouge_Bo.PNG',  name: 'Alerte Rouge',      icon: '\uD83D\uDD34', rarity: 'epic',      description: 'Score burn-out > 70 \u2014 situation critique',              condition: (s) => s.burnoutPeak > 70 },
            ...
            { id: 65, img: '../images/Renard_Expert.PNG',    name: 'Renard Expert',     icon: '\uD83C\uDFC6', rarity: 'legendary', description: 'Contingent 220h d\u00E9pass\u00E9 \u2014 tu connais le prix des heures', condition: (s) => s.contingentPercent >= 100 },
