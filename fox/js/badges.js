...
class BadgeSystem {
    ...
    initializeBadges() {
        return [
            ...
            { id: 54, img: '../images/AlerteJaune.PNG',     name: 'Alerte Jaune',      icon: '💛', rarity: 'common',    description: 'Score burn-out > 20 détecté',                          condition: (s) => s.burnoutPeak > 20 },
            ...
            { id: 57, img: '../images/JuristeJunior.PNG',   name: 'Juriste Junior',    icon: '⚖️', rarity: 'rare',      description: '5 scénarios juridiques narrés',                        condition: (s) => s.scenariosLegal >= 5 },
            { id: 58, img: '../images/AlerteOrange.PNG',    name: 'Alerte Orange',     icon: '🟠', rarity: 'rare',      description: 'Score burn-out > 50 détecté',                          condition: (s) => s.burnoutPeak > 50 },
            ...
            { id: 63, img: '../images/AlerteRouge.PNG',  name: 'Alerte Rouge',      icon: '🔴', rarity: 'epic',      description: 'Score burn-out > 70 — situation critique',              condition: (s) => s.burnoutPeak > 70 },
            ...
            { id: 65, img: '../images/RenardOmniscient.PNG',    name: 'Renard Expert',     icon: '🏆', rarity: 'legendary', description: 'Contingent 220h dépassé — tu connais le prix des heures', condition: (s) => s.contingentPercent >= 100 },
